...
The 0.2 series of releases will add more analysis specific plots. It will move code from `viz.py` to more specific modules, add links to acore and populate the static/interactive plots modules.

## What's Changed
* Align `src` codebase with latest Ruff ruleset by [@enryH](https://github.com/enryH) with [@Copilot](https://github.com/Copilot) in [#47](https://github.com/Multiomics-Analytics-Group/vuecore/pull/47)
* Mv enrichment plot by [@enryH](https://github.com/enryH) in [#45](https://github.com/Multiomics-Analytics-Group/vuecore/pull/45)

## New Contributors
* [@enryH](https://github.com/enryH) with [@Copilot](https://github.com/Copilot) made their first contribution in [#47](https://github.com/Multiomics-Analytics-Group/vuecore/pull/47)

**Full Changelog**: https://github.com/Multiomics-Analytics-Group/vuecore/compare/v0.1.1...v0.2.0
