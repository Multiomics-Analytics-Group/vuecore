...
from .theming import apply_scatter_map_theme
...
def build(data: pd.DataFrame, config: ScatterMapConfig) -> go.Figure:
    """
    ...
    Plotly Express implementation. It translates the validated `ScatterMapConfig`
    ...
    return build_plot(
        ...
        theming_function=apply_scatter_map_theme,
